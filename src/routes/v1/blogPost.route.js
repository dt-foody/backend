const BaseRoute = require('../../utils/_base.route'); // Import BaseRoute
const { blogPostController } = require('../../controllers/index');
const { blogPostValidation } = require('../../validations/index');
